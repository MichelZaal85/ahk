...
:*C1:V0000::V0001{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}Begane Grond{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
:*C1:V0100::V0002{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}1e Verdieping{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
:*C1:V0203::V0003{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}2e Verdieping{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
:*C1:V0304::V0004{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}3e Verdieping{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
:*C1:V0405::V0005{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}4e Verdieping{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
:*C1:V0506::V0006{tab 6}Mul BV Ontwerpers & Advisseurs{shiftdown}{ctrldown}{tab}{ctrlup}{shiftup}{tab}Ontruimingsplattegrond ,{tab}5e Verdieping{tab 6}A3{tab 2}(C)omputer{tab}V{tab}STABICAD{tab 8}{end}
